...
const Mersi = () => {
  ...
  const [pricePerRoom] = useState(5000);
  ...
  return (
    <div className="Residence">
      <Carousel>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/innfqoryklfs.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/ofdstlirvdcq.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/cswkscmbytrj.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/idhnordxamjc.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/fefspjlacnjw.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item interval={5}>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/fdtqamceyutm.jpg"
            alt="pic7"
          />
          <Carousel.Caption>
            <p>
        ...
        <img
          style={{ maxHeight: "400px" }}
          className="d-block w-100 "
          src="https://images.oyoroomscdn.com/uploads/hotel_image/242558/large/rcjmnbgngwvt.jpg"
          alt="pic8"
        />
        <Carousel.Caption>
          <p>
      ...
      <div className="Res">
        <h2>Hotel Mersi Hyderabad Near Bhrundavan colony</h2>
        <p style={{ color: "gray" }}>
        Pl no 13, Lakshmipuram Colony, Shivas Enclave, Brindavan Colony, Hyderabad
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
      ...
      <div className="footer">
        <h2>
          ...
          Lakshmipuram Colony, Brindavan Colony, Hyderabad.
        </h2>
