...
const Munnar= () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/e6a9745df7a1d503.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/1e640636913c26c1.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/937cb93bd27b62b0.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/1df75f4cc6e6e853.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/c324557df7e8dbbe.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item interval={5}>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/6ce2d7ea8b32b35b.jpg"
            alt="pic7"
          />
          <Carousel.Caption>
            <p>
        ...
        <img
          style={{ maxHeight: "400px" }}
          className="d-block w-100 "
          src="https://images.oyoroomscdn.com/uploads/hotel_image/17728/large/850dedaa885d3978.jpg"
          alt="pic8"
        />
        <Carousel.Caption>
          <p>
      ...
      <div className="Res">
        <h2>Hotel Munnar Near Devikulam, Idukki</h2>
        <p style={{ color: "gray" }}>
        Nh85, Koickakudy, Devikulam, Idukki, A Munnar Kerala India, Munnar
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
      ...
      <div className="footer">
        <h2>
          ...
          Devikulam, Idukki, A Munnar Kerala India, Munnar
        </h2>
