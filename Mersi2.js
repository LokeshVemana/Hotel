...
const Mersi2 = () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218891/large/ynuvllipraqj.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218891/large/pklwnrbmrdxd.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218891/large/mtvxmtavbltp.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218891/large/aomvurkxrxte.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218891/large/ttscbsqwqhvf.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item interval={5}>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218891/large/ukbnoycxhfam.jpg"
            alt="pic7"
          />
          <Carousel.Caption>
            <p>
        ...
        <img
          style={{ maxHeight: "400px" }}
          className="d-block w-100 "
          src="https://images.oyoroomscdn.com/uploads/hotel_image/174383/medium/f439c5885cff09e4.jpg"
          alt="pic8"
        />
        <Carousel.Caption>
          <p>
      ...
      <div className="Res">
        <h2>Hotel Mersi Hyderabad NearVellathooval, Munnar</h2>
        <p style={{ color: "gray" }}>
        Vellathooval, Munnar ,Kerala
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
        ...
        Vellathooval, Munnar ,Kerala
        <p>
        The location is atleast 18+ km away from munar but staying at this places helps cover the other beautiful places nearby like kallimali view point and the dam . The rooms are neat and clean but no hot water facility and food/tea available at stay on request the owners arranged to get it for us from their home.
        </p>
        </p>
      ...
      <div className="footer">
        <h2>
          Hotel Mersi is one of the main branches of Lotus .Located at
          Vellathooval, Munnar ,Kerala
        </h2>
        ...
        <div>
          ...
          >
            <Card.Body className="Pricing">
              ...
              <Button> <Link className="nav-link active" to={"/WelcomePage"}>
              Book Now
            </Link></Button>
            </Card.Body>
          </Card>
