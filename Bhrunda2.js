...
const Lakshyu = () => {
  ...
  const [pricePerRoom] = useState(2500);
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/113888/medium/af6ed6da21d091fe.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/113888/large/835069c02381cf22.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/113888/large/176fb41b6d926c01.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/113888/large/1780bdf6631e1b99.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/186236/large/ptijdesukuau.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
      ...
      <div className="Res">
        <h2>Hotel Bhrundha Near M V p Colony,Vizag</h2>
        <p style={{ color: "gray" }}>
        plot-19, sector-5 1-104-27, M V P Colony, Visakhapatnam
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <h3>Contact Us</h3>
              <p>plot-19, sector-5 1-104-27, M V P Colony, Visakhapatnam</p>
