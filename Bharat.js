...
const Lakshyu = () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/228043/large/mhljnvmjapqs.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/228043/large/dhcjfygdmwxb.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/228043/large/nynkcoeoqgvy.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/228043/large/tbqvvunuqven.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/228043/large/bjjoybhqmrgl.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/228043/large/elbyurnqobcy.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
      ...
      <div className="Res">
        <h2>Hotel Bharat Bangalore Near Electronic City</h2>
        <p style={{ color: "gray" }}>
        137, #14, Lavakusha Nagar, Beratena Agrahara, Hosa road, Electronic City, Bangalore
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
        ...
        <b>Location</b>
        <p>
        #14, Lavakusha Nagar, Beratena Agrahara, Hosa road, Electronic City, Bangalore
        </p>
      ...
      <div className="footer">
        <h2>
          Hotel Bharat is one of the main branches of Lotus .Located at
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <h3>Contact Us</h3>
              <p>#14, Lavakusha Nagar, Beratena Agrahara, Hosa road, Electronic City, Bangalore</p>
