...
const Thunder = () => {
  ...
  const [pricePerRoom] = useState(1800);
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/3b9a06d0ec13c1a8.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/d57d37a89f9094b8.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/e6af802e1e2a680c.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/cc0350a46facb126.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/1294d5aa646ad252.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/f85343925f71e2e2.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/83ddf6d691e0c44c.jpg"
            alt="pic7"
          />
          <Carousel.Caption>
            {/* <h3>Six slide label</h3> */}
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/62540/large/1fa34ca98d59c3b2.jpg"
            alt="pic8"
          />
          <Carousel.Caption>
            {/* <h3>Six slide label</h3> */}
      ...
      <div className="Res">
        <h2>Hotel Thunder Hyderabad Near D K Road Ameerpet</h2>
        <p style={{ color: "gray" }}>
        2, 7-1-211/25, Opp Indian Bank, D K Road, Ameerpet, Hyderabad
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
      ...
      <div className="footer">
        <h2>
          Hotel Thunder is one of the main branches of Lotus .Located at
       Ameerpet, Hyderabad
        </h2>
