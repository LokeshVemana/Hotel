...
const Mantra = () => {
  ...
  const [pricePerRoom] = useState(3500);
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/xbomalxwniyv.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/bsqgfpwywyll.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/slvibxneqkgv.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/dfjhlsceiefd.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/girsyeleepxn.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/ghrqhngueepf.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item interval={5}>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/pamuxsqxywhf.jpg"
            alt="pic7"
          />
          <Carousel.Caption>
            <p>
        ...
        <img
          style={{ maxHeight: "400px" }}
          className="d-block w-100 "
          src="https://images.oyoroomscdn.com/uploads/hotel_image/112610/large/gbtciuldfsuj.jpg"
          alt="pic8"
        />
        <Carousel.Caption>
          <p>
      ...
      <div className="Res">
        <h2>Hotel Mantra Near Daba-Garden</h2>
        <p style={{ color: "gray" }}>
          30-08-08, Bhanu street, Daba gardens, Visakhapatnam 4.6 195 Ratings
          FLAGSHIP
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <h3>Contact Us</h3>
              <p>
              30-08-08, Bhanu street, Daba gardens, Visakhapatnam
              </p>
        ...
        <div>
          ...
          >
            <Card.Body className="Pricing">
              ...
              <Button>
                {" "}
                <Link className="nav-link active" to={"/WelcomePage"}>
                  Book Now
                </Link>
              </Button>
            </Card.Body>
