...
const Fico= () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/36701/large/5ea09955bca81b15.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/36701/large/3f49ee2e42476799.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/36701/large/0ddddb1db5b021c2.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/36701/large/95b8699a049b1cb9.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/36701/large/568bf818ae07d864.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/36701/large/33473d4fbd6a2100.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
      ...
      <div className="Res">
        <h2>Hotel Finco Bangalore Near BTM layout</h2>
        <p style={{ color: "gray" }}>
        1, 21, Old Madiwala, Madiwala, 1st Stage, B T M Layout, Bangalore
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
        ...
        <p>
        1, 21, Old Madiwala, Madiwala, 1st Stage, B T M Layout, Bangalore
        <p>Near Anjaneya Temple Madiwala, Hosur Main road.</p>
        </p>
      ...
      <div className="footer">
        <h2>
          Hotel Lakshyu is one of the main branches of Lotus .Located at
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <h3>Contact Us</h3>
              <p>137, 1st B cross Road, Domlur 2nd stage, Indiranagar, Bangalore, India, Bangalore</p>
