...
const Metric = () => {
  ...
  const [pricePerRoom] = useState(10000);
  ...
  return (
    <div className="Residence">
      <Carousel>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/tltximgmiumi.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/hjftyylkbple.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/vktlkxxwmuyd.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/igiwhniyrpyv.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/laehxbchdlut.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item interval={5}>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/gdjhfdikqmdq.jpg"
            alt="pic7"
          />
          <Carousel.Caption>
            <p>
        ...
        <img
          style={{ maxHeight: "400px" }}
          className="d-block w-100 "
          src="https://images.oyoroomscdn.com/uploads/hotel_image/218716/large/bcuxkdyjpfal.jpg"
          alt="pic8"
        />
        <Carousel.Caption>
          <p>
      ...
      <div className="Res">
        <h2>Hotel Metric Bangalore Near Balachandra layout</h2>
        <p style={{ color: "gray" }}>
          No.82/8, Flower Garden Road, Balachandra Layout, Babusabpalya,
          Bangalore
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        ...
        <b>Location</b>
        <p>
          The property is 8 min away from the ISB campus in Gachibowli. The GHMC
          park is right next to the property premises.
          <p>It is also very near to JV colony.</p>
        </p>
      ...
      <div className="footer">
        <h2>
          Hotel Metric is one of the main branches of Lotus .Located at
          Balachandra layout,Bangalore.
        </h2>
