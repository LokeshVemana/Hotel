...
const Bhrunda3 = () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/235109/large/ghbgyaqbeaxp.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/235109/large/fcxucqecbyxk.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/235109/large/enqianqcnmgf.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/235109/large/yhsosprqxvjk.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/235109/large/rcdsmpqkdlnp.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
      ...
      <div className="Res">
        <h2>Hotel Bhrundha Near Cloudy Mist Munnar</h2>
        <p style={{ color: "gray" }}>
        4/520/B,4/520/B1,4/520/B2, CLOUDY MIST, ANACHAL, SANKUPPADI, Chittirapuram,, Chekuthan Mukku, Munnar
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
      ...
      <div className="footer">
        <h2>
          ...
          Chittirapuram,, Chekuthan Mukku, Munnar,kerala.
        </h2>
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <h3>Contact Us</h3>
              <p>4/520/B,4/520/B1,4/520/B2, CLOUDY MIST, ANACHAL, SANKUPPADI, Chittirapuram,, Chekuthan Mukku, Munnar</p>
