...
const Bhrunda = () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/114586/large/mwghxeqfmxkf.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/114586/large/kudjxuvwawet.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/114586/large/idqhtmoohjht.jpg"
            alt="pic3"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            ...
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/114586/large/fgypnxbfnajx.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/114586/large/wvliwfeeyiul.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/114586/large/yfkhwkcibggd.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
      ...
      <div className="Res">
        <h2>Hotel Bhrunda Bangalore Near Whitefield</h2>
        <p style={{ color: "gray" }}>
        No 69 2 Garudacharpalya Mahadevapura village, Whitefield Rd, KR Puram Hobli, Bangalore
        </p>
        <h3>Amenities</h3>
        <p>Free wifi</p>
        <p>AC</p>
        ...
        <b>Location</b>
        <p>
          TNo 69 2 Garudacharpalya Mahadevapura village, Whitefield Rd, KR Puram Hobli, Bangalore
        </p>
      ...
      <div className="footer">
        <h2>
          Hotel Bhrunda is one of the main branches of Lotus .Located at
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              <h3>Contact Us</h3>
              <p>TNo 69 2 Garudacharpalya Mahadevapura village, Whitefield Rd, KR Puram Hobli, Bangalore</p>
