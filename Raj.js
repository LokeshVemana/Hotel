...
const Raj = () => {
  ...
  return (
    <div className="Residence">
      <Carousel>
        <Carousel.Item interval={5}>
          <img
            ...
            src="https://images.oyoroomscdn.com/uploads/hotel_image/197931/large/gpjgobcikixu.jpg"
            alt="Pic1"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px",objectFit:'cover' }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/197931/large/bahfavrdmstt.jpg"
            alt="pic2"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px" ,objectFit:'cover'}}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/197931/large/fylqbdckaeqo.jpg"
            alt="pic4"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            style={{ maxHeight: "400px",objectFit:'cover' }}
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/40154/large/iihforcjaapx.jpg"
            alt="pic5"
          />
          <Carousel.Caption>
        ...
        <Carousel.Item>
          <img
            ...
            className="d-block w-100 "
            src="https://images.oyoroomscdn.com/uploads/hotel_image/40154/large/sushpvoomare.jpg"
            alt="pic6"
          />
          <Carousel.Caption>
      ...
      <div className="Res">
        <h2>Hotel Raj Hyderabad Near Madhapur</h2>
        <p style={{ color: "gray" }}>
